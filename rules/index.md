...
# Rules index (ordered discovery path)

This is the **recommended reading path** for agents. Follow it top-to-bottom.

## Start (read first)
- `rules/start/start-here.md` (intake questions + defaults)
- `rules/start/requirements.md` (capabilities + env)
- `rules/start/pipeline-voiceover-first.md`
- `rules/start/end-to-end.md` (full runbook)
